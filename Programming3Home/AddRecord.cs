...
///The Add records funcitonality was completed by Kyle Hutchinson. Minor amendments were made by Orion Williams and are marked within the code.
...
namespace Programming3Home
{
    public partial class AddRecord : Form
    {
        ...
        {
            // The following commented out code was done by Orion Williams:
            //var home = new Home();
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            //Orion Williams added the following two lines of Code:
            string serviceIDquery = "update clients set ServiceID='" + clientID.ToString() + "' where ClientID='" + clientID.ToString() + "'";
            mySQLConnector.ExecuteQuery(serviceIDquery);
